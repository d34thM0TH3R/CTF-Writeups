...
The data consists of a lot of 0x90 hex bytes, which is also known as a NOP sled.  
...
The `-Ss 999` flag reads from stdin and will step 9999 times. The 9999 is arbitrary and is to make sure it fully decompiles.
